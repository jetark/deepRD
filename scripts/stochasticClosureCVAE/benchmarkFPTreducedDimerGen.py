...
from deepRD.noiseSampler import noiseSampler, defaultSamplingModel, cvaeSampler
...
bsize= 5
conditionedOn = 'local_dqipipimririm' # Available conditionings: qi, pi, ri, qiri, piri, qiririm, piririm

# Output data directory
foldername = 'dimerGlobal/boxsize' + str(bsize) + '/benchmarkFPTreducedGen_DAG2'
...
model_state_path = localModelDirectory + f"ckpts/cvae_checkpoint_{systemType}_{conditionedOn}_DAG2.pt"
normalizers_path = localModelDirectory + f"normalizers/normalizers_{systemType}_{conditionedOn}_DAG2.pkl"

# Load binning sampling models
print("Loading binned data ...")
binnedDataFilename = localDataDirectory + 'dimerGlobal/boxsize' + str(bsize) + '/binnedData/piBinnedData.pickle'
